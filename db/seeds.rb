...
# end
jo = Talent.create(name: "Jo", age: 19, height: "6'3", weight: 165, primary_position: 'Goalie', secondary_position: 'Mid Fielder', video_url: 'www.futboltube/jo', zipcode: 80013, email: 'jo@futboltube', dominant_foot: 'R', goals_made_ls: 4, vertical_jump: 3.7, forty_dash: 7.8, juggling_record: 30, awards: 'MVP')
dee = Talent.create(name: "Dee", age: 24, height: "5'4", weight: 185, primary_position: 'Center Back', secondary_position: 'Right Mid', video_url: 'www.futboltube/dee', zipcode: 80207, email: 'dee@futboltube', dominant_foot: 'R', goals_made_ls: 8, vertical_jump: 10.7, forty_dash: 10.8, juggling_record: 15, awards: 'Rookie of the Year')
bigT = Talent.create(name: "T'variusness King", age: 24, height: "6'0", weight: 185, primary_position: 'Denfensive Mid', secondary_position: 'Center Back', video_url: 'www.futboltube/bigT', zipcode: 80219, email: 'bigT@futboltube', dominant_foot: 'L', goals_made_ls: 0, vertical_jump: 20, forty_dash: 5, juggling_record: 13, awards: 'Most Improved Player')
stephen = Talent.create(name: "Steven", age: 17, height: "5'10", weight: 185, primary_position: 'Wing Back', secondary_position: 'Defensive Mid', video_url: 'www.futboltube/steven', zipcode: 80013, email: 'steven@futboltube', dominant_foot: 'R', goals_made_ls: 4, vertical_jump: 24, forty_dash: 9.8, juggling_record: 15, awards: 'Defensive Player of the Year')
will = Talent.create(name: "Willy P", age: 17, height: "5'7", weight: 185, primary_position: "Striker", secondary_position: 'Foward', video_url: 'www.futboltube/willP', zipcode: 80134, email: 'willP@futboltube', dominant_foot: 'L', goals_made_ls: 4, vertical_jump: 18.7, forty_dash: 12, juggling_record: 14, awards: 'Sixth man of the Year')
andrey = Talent.create(name: "Andrey", age: 25, height: "6'0", weight: 185, primary_position: 'Full Back', secondary_position: 'Striker', video_url: 'www.futboltube/andrey', zipcode: 80207, email: 'andrey@futboltube', dominant_foot: 'R', goals_made_ls: 1, vertical_jump: 20, forty_dash: 7.8, juggling_record: 30, awards: 'Finals MVP')
